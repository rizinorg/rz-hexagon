...
def write_files_rizin(ins_class, ins_duplex, hex_insn_names, extendable_insn):
    ...
    lines = auto_header + header_guard + hlines + ["", "#endif"]
    ...
    lines = auto_header + includes + make_C_block(lines, "int hexagon_disasm_instruction(ut32 hi_u32, HexInsn *hi, ut32 addr)", None, "return 4;")
    ...
    includes += ["#include \"hexagon_insn.h\""]
    includes += [""] # for the sake of beauty
    lines = auto_header + includes + lines
